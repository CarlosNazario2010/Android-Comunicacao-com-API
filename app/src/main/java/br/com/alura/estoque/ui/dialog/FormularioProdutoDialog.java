...
abstract public class FormularioProdutoDialog {
    ...
    public void mostra() {
        @SuppressLint("InflateParams") View viewCriada = LayoutInflater
                .from(context)
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(tituloBotaoPositivo, (dialog, which) -> {
                    EditText campoNome = getEditText(
                            viewCriada, R.id.formulario_produto_nome);
                    EditText campoPreco = getEditText(
                            viewCriada, R.id.formulario_produto_preco);
                    EditText campoQuantidade = getEditText(
                            viewCriada, R.id.formulario_produto_quantidade);
    ...
    private void tentaPreencherFormulario(View viewCriada) {
        if (produto != null) {
            TextView campoId = viewCriada.findViewById(
                    R.id.formulario_produto_id);
    ...
    private void criaProduto(EditText campoNome,
                             EditText campoPreco,
